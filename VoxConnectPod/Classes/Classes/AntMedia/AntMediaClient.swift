...
open class AntMediaClient: NSObject, AntMediaClientProtocol {
    ...
    public func setOptions(url: String,
                           streamId: String,
                           token: String = "",
                           mode: AntMediaClientMode = .join,
                           enableDataChannel: Bool = false,
                           captureScreenEnabled: Bool = false,
                           userType: UserType) {
    ...
    open func initPeerConnection() {
        ...
        if (self.webRTCClient == nil) {
            ...
            self.webRTCClient = AntMediaWebRTCClient(remoteVideoView: remoteView,
                                                     ...
                                                     multiPeerActive:  self.multiPeer,
                                                     enableDataChannel: self.enableDataChannel,
                                                     captureScreen: self.captureScreenEnabled,
    ...
    open func isConnected() -> Bool {
        return self.isWebSocketConnected
    }
    ...
    open func muteIncomingAudio() {
        self.webRTCClient?.muteIncomingAudio()
    }
